...
import (
	...
	"github.com/foobarprogacct/testoperator/pkg/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type TestV1Interface interface {
	RESTClient() rest.Interface
	TestIstioOperatorsGetter
}

// TestV1Client is used to interact with features provided by the test.istio group.
type TestV1Client struct {
	restClient rest.Interface
}

func (c *TestV1Client) TestIstioOperators(namespace string) TestIstioOperatorInterface {
	return newTestIstioOperators(c, namespace)
}
